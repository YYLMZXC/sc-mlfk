            ...
            for (int i = 0; i < base.Particles.Length; i++)
            {
                ...
                for (int j = 0; j < (int)(particle.TimeToLive * 30f); j++)
                {
                    ...
                    while (num4 > position.Y)
                    {
                        ...
                        float num6 = MathUtils.Lerp(4f, 10f, (float)(double)(num5 & 0xFFu) / 255f);
                        float num7 = (((num5 & 1) == 0) ? 1 : (-1));
                        float num8 = MathUtils.Lerp(0.05f, 0.2f, (float)(double)((num5 >> 8) & 0xFFu) / 255f);
                        float num9 = num4;
                        float y = num9 - num6 * MathUtils.Lerp(0.45f, 0.55f, (float)(double)((num5 >> 16) & 0xFFu) / 255f);
                        float y2 = num9 - num6 * MathUtils.Lerp(0.45f, 0.55f, (float)(double)((num5 >> 24) & 0xFFu) / 255f);
                        float y3 = num9 - num6;
