...
namespace Game
{
	public class CommandCamera : BasePerspectiveCamera
	{
		...
		public override bool IsEntityControlEnabled
		{
			get
			{
				return m_isEntityControlEnabled;
			}
		}
		...
		public override void Update(float dt)
		{
			...
			{
				ComponentPlayer componentPlayer2 = base.GameWidget.PlayerData.ComponentPlayer;
				Vector3 playerBodyDirection = DataHandle.GetPlayerBodyDirection(componentPlayer2);
				...
				m_position = componentPlayer2.ComponentBody.Position + vector4 + vector5 + vector6;
				m_direction = DataHandle.EyesToDirection(DataHandle.EyesAdd(DataHandle.GetPlayerEyesAngle(componentPlayer2), m_relativeAngle));
				SetupPerspectiveCamera(m_position, m_direction, Vector3.UnitY);
			}
		}
	}
