...
namespace Mlfk
{
    public class SubsystemCommandBlockBehavior : SubsystemBlockBehavior, IDrawable
    {
        ...
        public override void Load(ValuesDictionary valuesDictionary)
        {
            ...
            m_batchesByType[0] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp0"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
            m_batchesByType[1] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp0"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
            m_batchesByType[2] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp0"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
            m_batchesByType[3] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp0"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
            m_batchesByType2[0] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp1"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
            m_batchesByType2[1] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp2"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
            m_batchesByType2[2] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp3"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
            m_batchesByType2[3] = m_primitivesRenderer.TexturedBatch(ContentManager.Get<Texture2D>("Textures/Csharp4"), useAlphaTest: false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.LinearClamp);
        }
        ...
        public override void OnBlockModified(int value, int oldValue, int x, int y, int z)
        {
            ...
            if (m_chartlets.TryGetValue(key, out var value2))
            {
        ...
        {
            OnBlockGenerated(value, x, y, z, isLoaded: false);
        }
        ...
        {
            if (m_commandDatas.TryGetValue(position, out var value))
            {
                return value;
            }
        ...
        public CommandData SetCommandData(Point3 position, string line)
        {
            ...
            base.Project.FindSubsystem<SubsystemCommand>(throwOnError: true).ShowEditedTips(tip);
